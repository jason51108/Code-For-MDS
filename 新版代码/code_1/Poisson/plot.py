...
def plot_boxplot(data_dict, setting, title='Losses Boxplot'):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(rf'/home/user/CYH/Code_For_MDS/image/Poisson/{Ip.setting}.png')

if __name__ == '__main__':
    # Calculate losses and plot boxplots
    # os.chdir(r'/data/Test_CYH/code')
    os.makedirs(f'/home/user/CYH/Code_For_MDS/image/Poisson/', exist_ok=True)
    base_folder = rf'/home/user/CYH/Code_For_MDS/para_result/Poisson/{Ip.setting}'
    ...
    plot_boxplot(losses_dict, Ip.setting)